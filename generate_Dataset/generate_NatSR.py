...
parser.add_argument('--tfrecord', dest='tfrecord', help='Save path for tfrecord file', default='train_NatSR_X%d.tfrecord' % scale)
...
if __name__=='__main__':
    data_ready_SR(datapath, labelpath, tfrecord_file,48*scale,48*scale,120)
    print('Done')